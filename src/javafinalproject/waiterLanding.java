 ...
 * @author 2ndyrGroupA
 */
public class waiterLanding extends javax.swing.JFrame {

    /**
     * Creates new form userLanding
     */
    public waiterLanding() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(waiterLanding.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new waiterLanding().setVisible(true);
            }
        });
    }
